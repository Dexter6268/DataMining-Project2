...
if __name__ == "__main__":
    ...
    parser.add_argument("--min_child_samples", type=int, default=10, help="Minimum child samples in LightGBM.")
    parser.add_argument("--min_split_gain", type=float, default=0.0, help="Minimum split gain in LightGBM.")
