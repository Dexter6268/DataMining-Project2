...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train RandomForest on Breast Cancer Dataset.")
    ...
    parser.add_argument("--log_dir", type=str, default="results/breastCancer/randomforest", help="Directory to save the log files.")
