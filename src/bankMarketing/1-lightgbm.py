...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train LightGBM on Bank Marketing Dataset.")
    ...
    parser.add_argument("--max_depth", type=int, default=-1, help="Maximum tree depth in LightGBM.")
